...
namespace TennisRanking.Data.Migrations
{
    ...
    [Migration("20210202164307_AddRegrasAgendaAmistoso")]
    partial class AddRegrasAgendaAmistoso
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TennisRanking.Models.HorarioHabilitadoAmistoso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("HorariosHabilitadoAmistoso");
                });
            ...
            modelBuilder.Entity("TennisRanking.Models.HorarioHabilitadoDesafio", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            DiaSemana = (byte)4,
                            HorarioFinal = new DateTime(2021, 2, 2, 22, 0, 0, 0, DateTimeKind.Unspecified),
                            HorarioInicial = new DateTime(2021, 2, 2, 19, 0, 0, 0, DateTimeKind.Unspecified),
                            QuadraId = 1
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = 3,
                            DiaSemana = (byte)7,
                            HorarioFinal = new DateTime(2021, 2, 2, 20, 0, 0, 0, DateTimeKind.Unspecified),
                            HorarioInicial = new DateTime(2021, 2, 2, 15, 0, 0, 0, DateTimeKind.Unspecified),
                            QuadraId = 1
                        },
                        new
                        {
                            Id = 4,
                            DiaSemana = (byte)1,
                            HorarioFinal = new DateTime(2021, 2, 2, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            HorarioInicial = new DateTime(2021, 2, 2, 9, 0, 0, 0, DateTimeKind.Unspecified),
                            QuadraId = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("TennisRanking.Models.RegrasAgendaAmistoso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("HorarioLiberarAgendamento")
                        .HasColumnType("datetime2");

                    b.Property<byte>("MinimoDiasEntreAmistosos")
                        .HasColumnType("tinyint");

                    b.Property<byte>("MultaWO")
                        .HasColumnType("tinyint");

                    b.Property<byte>("PrazoMinutosCancelamentoSemMulta")
                        .HasColumnType("tinyint");

                    b.Property<byte>("PrazoMinutosReagendamentoSemWO")
                        .HasColumnType("tinyint");

                    b.HasKey("Id");

                    b.ToTable("RegrasAgendaAmistoso");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            AntecedenciaMaximaDias = (byte)2,
                            HorarioLiberarAgendamento = new DateTime(2021, 2, 2, 13, 0, 0, 0, DateTimeKind.Unspecified),
                            MinimoDiasEntreAmistosos = (byte)2,
                            MultaWO = (byte)20,
                            PrazoMinutosCancelamentoSemMulta = (byte)60,
                            PrazoMinutosReagendamentoSemWO = (byte)60
                        });
                });
            ...
            modelBuilder.Entity("TennisRanking.Models.RegrasGerais", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PrazoHorasRespostaDesafio = (byte)24,
                            PrazoMinutosCancelamentoSemMulta = (byte)60,
                            PrazoMinutosReagendamentoSemWO = (byte)60,
